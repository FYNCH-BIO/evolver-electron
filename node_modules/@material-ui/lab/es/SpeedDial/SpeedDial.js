  ...
  render() {
    const _this$props = this.props,
      ...
      TransitionProps
          ...
          other = _objectWithoutProperties(_this$props, ["ariaLabel", "ButtonProps", "children", "classes", "className", "hidden", "icon", "onClick", "onClose", "onKeyDown", "open", "direction", "openIcon", "TransitionComponent", "transitionDuration", "TransitionProps"]); // Filter the label for valid id characters.
    ...
    return React.createElement("div", _extends({
      ...
      unmountOnExit: true
    }, TransitionProps), React.createElement(Button, _extends({
      variant: "fab",
      color: "primary",
      onKeyDown: this.handleKeyDown,
    ...
    }, clickProp, ButtonProps), icon())), React.createElement("div", {
      id: `${id}-actions`,
      role: "menu",
