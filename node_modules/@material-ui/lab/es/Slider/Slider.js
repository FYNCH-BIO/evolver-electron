...
export const styles = theme => {
  ...
  const commonTransitions = theme.transitions.create(['width', 'height', 'left', 'top', 'box-shadow'], commonTransitionsOptions); // no transition on the position

  const thumbActivatedTransitions = theme.transitions.create(['width', 'height', 'box-shadow'], commonTransitionsOptions);
  const colors = {
  ...
  render() {
    ...
    const _this$props = this.props,
      ...
      vertical
          ...
          other = _objectWithoutProperties(_this$props, ["className", "classes", "component", "thumb", "disabled", "max", "min", "onChange", "onDragEnd", "onDragStart", "reverse", "step", "theme", "value", "vertical"]);
