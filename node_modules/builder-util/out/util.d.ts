...
export declare function serializeToYaml(object: object, skipInvalid?: boolean, noRefs?: boolean): string;
...
export declare function executeAppBuilder(args: Array<string>, childProcessConsumer?: (childProcess: ChildProcess) => void): Promise<string>;
