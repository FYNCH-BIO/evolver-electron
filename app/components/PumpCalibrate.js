...
class PumpCal extends React.Component {
  ...
  generateButtonText = (currentStep) => {
    ...
    this.setState({
      ...
      buttonAdvanceText: buttonAdvanceText,
      buttonBackText: buttonBackText,
      pumpCalModesFiltered: pumpCalModes
    });
  };
  ...
  //BUG HERE - if only cal IN1 and E fast, E shows slow rate.
  ...
  render() {
    ...
    if (this.state.currentStep == 0) {
      pumpConfig = < div style = {
        ...
        <
        div className = "instructionsDiv" > < p className = "configInstructions" > Select the pump configuration
      for your eVOLVER setup < /p></div >
        <
        br / >
        <
        div className = 'col'
      style = {
        ...
        PumpCalRadioButtons name = 'IN1'
      onSelectRadio = {
        this.handleSelectRadio
      }
      value = {
        this.state.pumpCalModes[0].arrayMode
      }
      /> <
      /div> <
      div className = 'row' >
        ...
        PumpCalRadioButtons name = 'IN2'
      onSelectRadio = {
        this.handleSelectRadio
      }
      value = {
        this.state.pumpCalModes[1].arrayMode
      }
      /> <
      /div> <
      div className = 'row' >
        <
        span className = "radioBtnRowLabel"
      style = {
          {
        ...
        <
        PumpCalRadioButtons name = 'E'
      onSelectRadio = {
        this.handleSelectRadio
      }
      value = {
        this.state.pumpCalModes[2].arrayMode
      }
      /> <
      /div> <
      /div> <
      ...
      pumpConfig = <
        PumpcalInput
      onChangeValue = {
        this.handlePumpAmountInput
      }
      onInputsEntered = {
        this.state.inputsEntered
      }
      enteredValues = {
        this.state.enteredValues[this.state.pumpCalModesFiltered[currentStep - 1].arrayName]
      }
      />
    }
    ...
    if (this.state.currentStep != 0) {
      ...
      onClick = {
        ...
        Start Pump Calibration < FaPlay size = {
          17
        }
      /> <
      /button> <
    ...
    return ( <
      ...
      <
      Card className = {
        classes.cardPumpCalGUI
      } >
      <
      VialSelectorPumpCal items = {
        this.state.vialData
      }
      vialSelectionFinish = {
        this.onSelectVials
